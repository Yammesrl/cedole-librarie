...
Il campo “priorità” permette di far ordinare i numeri da 01 a 99
...
L’utente, può disabilitare il proprio cellulare, da impostazioni del sito deselezionando il box.
...
L’Amministrazione Trasparente costituisce una sezione a parte rispetto al resto del sito con la sua galleria di documenti.

 Il \ |STYLE136|\  degli allegati alle varie sezioni, va effettuato nella  galleria dei documenti da Explorer

\ |IMG37|\ 

Il caricamento può essere effettuato in 2 modalità:
...
Una volta effettuato il caricamento del documento, nella sezione di “editing”, la scheda, Allegati e Collegamenti, dà la possibilità di caricare link al documento da allegare.

Per es.

\ |IMG39|\ 

\ |STYLE137|\  va scritto un titolo generico per es. Allegati o Modulistica che raggruppa 1 o più documenti che si vogliono allegare

\ |STYLE138|\  è il titolo del singolo documento 
\ |STYLE139|\  è l’url del documento che si trova nel sito. Cliccando sul simbolo a lato della cartella di download, si visualizza la seguente finestra: \ |IMG40|\ 

A questo punto cercare il file nella cartella specifica cliccando sulla lente di ingrandimento che mostra tutti i file contenuti nella cartella.
...
Le immagini che vanno caricate nel sito per \ |STYLE140|\ , devono avere una dimensione ottimale di 750\*407  (anche 400)
...
Le immagini \ |STYLE141|\  che vanno caricate nel sito per \ |STYLE142|\  , devono avere una dimensione ottimale 1622\*390  
...
Inoltre per la \ |STYLE143|\  sono  necessarie nr.1 immagine verticale e 1 orizzontale
...
Le immagini delle \ |STYLE144|\  (9 aree in home page: Amministrazione, Servizi al cittadino, Politiche sociali, ecc) devono essere tutte della stessa dimensione e della maggior risoluzione possibile.
...
* I formati : tiff e bmp \ |STYLE145|\  sono standard web e non tutti i browser li supportano
...
Partendo dal portale in modalità Offline rispetto al progetto, in alto a destra nel browser cliccando sul simbolo della  \ |STYLE146|\  compaiono i sottostanti pulsanti.

\ |IMG47|\ 


+-----------+----------------------------------------------------------------------------------+
|\ |IMG48|\ |Tasto che permette di accedere alla mappa del portale per creare le container page|
+-----------+----------------------------------------------------------------------------------+
|\ |IMG49|\ |Tasto che apre il sito in Explorer                                                |
|           |                                                                                  |
+-----------+----------------------------------------------------------------------------------+
|\ |IMG50|\ |Tasto che apre il sito in modalità gestione utente                                |
|           |                                                                                  |
+-----------+----------------------------------------------------------------------------------+
|\ |IMG51|\ |Tasto Navicella che apre la visione di insieme dei tasti di gestione              |
+-----------+----------------------------------------------------------------------------------+


Il pulsante  \ |IMG52|\   permette di accedere alla \ |STYLE147|\ . 

\ |STYLE148|\  

\ |IMG53|\ 

Come mostra  la figura soprastante, in corrispondenza della cartella in cui si vuole creare la pagina, cliccare sul pulsante  \ |IMG54|\  “mostra menu”,  che elenca tutte le attività che si possono effettuare dalle singole pagine.

Cliccando sulla voce \ |STYLE149|\  (\ |STYLE150|\ ) è possibile, come nell’esempio, aggiungere una pagina in Uffici Comunali.

Compare la maschera di \ |STYLE151|\  come sotto rappresentata:

\ |IMG55|\ 

Ogni \ |STYLE152|\  contiene un corredo informativo e grafico particolare, per es. menu personalizzati, colori, multibox eccetera. 
...
Per es. si si vuole creare una servizio, un ufficio o una pagina che ha a che fare con il mondo scolastico, si selezionerà il \ |STYLE153|\ 
...
La posizione della pagina nella mappa, rispecchia la posizione della pagina nel menu contestuale del portale pubblico. Se si desidera collocarla in altra posizione, si può spostare l’oggetto tenendo premuto sul pulsante  \ |IMG56|\  e trascinandolo nella posizione preferita.

Per proseguire con l’attività,  cliccare sul tasto Mostra menu\ |IMG57|\ e selezionare la funzione \ |STYLE154|\  (\ |STYLE155|\ ) 

Al momento, con l’attività appena descritta, di fatto è stato creato esclusivamente \ |STYLE156|\  che si sta costruendo ovvero  un link che comparirà nel menu contestuale e che porta a una pagina vuota.
...
.. _h6248285f3433e7f696024202e3c6fa:
...
* evitare di  caricare documenti troppo pesanti (5 mega per es è troppo)

* evitare di caricare documenti scansionati per problemi di accessibilità

* \ |LINK6|\   sito utile per convertire i formati
...
.. |STYLE137| replace:: **Titolo:**

.. |STYLE138| replace:: **Etichetta dell’allegato:**

.. |STYLE139| replace:: **Url dell’allegato:**

.. |STYLE140| replace:: **notizie ed eventi**

.. |STYLE141| replace:: **panoramiche**

.. |STYLE142| replace:: **la testata**

.. |STYLE143| replace:: **app**

.. |STYLE144| replace:: **aree**

.. |STYLE145| replace:: **non**

.. |STYLE146| replace:: **navicella**

.. |STYLE147| replace:: **mappa del portale**

.. |STYLE148| replace:: **È in questa sezione che si creano le pagine cosiddette “container” che ospiteranno  (in seguito) il contenuto specifico.  Si  tratta di  involucri,  vuoti di contenuti, che corrispondono a voci di menu.**

.. |STYLE149| replace:: **Crea sotto-pagina**

.. |STYLE150| replace:: *Create child page*

.. |STYLE151| replace:: **selezione modello**

.. |STYLE152| replace:: **modello**

.. |STYLE153| replace:: **Modello per scuola.**

.. |STYLE154| replace:: **Mostra pagina**

.. |STYLE155| replace:: *Open in page editor*

.. |STYLE156| replace:: **l’involucro della pagina**
...
.. |LINK6| raw:: html
    ...
    <a href="https://cloudconvert.com/" target="_blank">https://cloudconvert.com/</a>


.. |IMG1| image:: static/Manuale_utente_sitoweb_1_1.png
   :height: 132 px
   :width: 244 px

.. |IMG2| image:: static/Manuale_utente_sitoweb_1_2.png
   :height: 338 px
   :width: 616 px

.. |IMG3| image:: static/Manuale_utente_sitoweb_1_3.png
   :height: 258 px
   :width: 620 px

.. |IMG4| image:: static/Manuale_utente_sitoweb_1_4.png
   :height: 440 px
   :width: 448 px

.. |IMG5| image:: static/Manuale_utente_sitoweb_1_5.png
   :height: 266 px
   :width: 641 px

.. |IMG6| image:: static/Manuale_utente_sitoweb_1_6.png
   :height: 309 px
   :width: 600 px

.. |IMG7| image:: static/Manuale_utente_sitoweb_1_7.png
   :height: 125 px
   :width: 306 px

.. |IMG8| image:: static/Manuale_utente_sitoweb_1_8.png
   :height: 202 px
   :width: 641 px

.. |IMG9| image:: static/Manuale_utente_sitoweb_1_9.png
   :height: 256 px
   :width: 641 px

.. |IMG10| image:: static/Manuale_utente_sitoweb_1_10.jpeg
   :height: 461 px
   :width: 641 px

.. |IMG11| image:: static/Manuale_utente_sitoweb_1_11.png
   :height: 361 px
   :width: 641 px

.. |IMG12| image:: static/Manuale_utente_sitoweb_1_12.png
   :height: 372 px
   :width: 620 px

.. |IMG13| image:: static/Manuale_utente_sitoweb_1_10.jpeg
   :height: 461 px
   :width: 641 px

.. |IMG14| image:: static/Manuale_utente_sitoweb_1_13.png
   :height: 298 px
   :width: 641 px

.. |IMG15| image:: static/Manuale_utente_sitoweb_1_14.png
   :height: 260 px
   :width: 664 px

.. |IMG16| image:: static/Manuale_utente_sitoweb_1_15.png
   :height: 120 px
   :width: 614 px

.. |IMG17| image:: static/Manuale_utente_sitoweb_1_16.png
   :height: 376 px
   :width: 554 px

.. |IMG18| image:: static/Manuale_utente_sitoweb_1_17.png
   :height: 684 px
   :width: 516 px

.. |IMG19| image:: static/Manuale_utente_sitoweb_1_18.png
   :height: 236 px
   :width: 641 px

.. |IMG20| image:: static/Manuale_utente_sitoweb_1_19.png
   :height: 256 px
   :width: 364 px

.. |IMG21| image:: static/Manuale_utente_sitoweb_1_20.png
   :height: 57 px
   :width: 374 px

.. |IMG22| image:: static/Manuale_utente_sitoweb_1_21.png
   :height: 210 px
   :width: 641 px

.. |IMG23| image:: static/Manuale_utente_sitoweb_1_22.png
   :height: 410 px
   :width: 641 px

.. |IMG24| image:: static/Manuale_utente_sitoweb_1_23.png
   :height: 345 px
   :width: 641 px

.. |IMG25| image:: static/Manuale_utente_sitoweb_1_24.png
   :height: 396 px
   :width: 641 px

.. |IMG26| image:: static/Manuale_utente_sitoweb_1_25.png
   :height: 216 px
   :width: 561 px

.. |IMG27| image:: static/Manuale_utente_sitoweb_1_26.png
   :height: 329 px
   :width: 545 px

.. |IMG28| image:: static/Manuale_utente_sitoweb_1_27.png
   :height: 413 px
   :width: 232 px

.. |IMG29| image:: static/Manuale_utente_sitoweb_1_28.png
   :height: 376 px
   :width: 641 px

.. |IMG30| image:: static/Manuale_utente_sitoweb_1_29.png
   :height: 542 px
   :width: 304 px

.. |IMG31| image:: static/Manuale_utente_sitoweb_1_30.png
   :height: 418 px
   :width: 373 px

.. |IMG32| image:: static/Manuale_utente_sitoweb_1_31.png
   :height: 300 px
   :width: 473 px

.. |IMG33| image:: static/Manuale_utente_sitoweb_1_32.png
   :height: 400 px
   :width: 485 px

.. |IMG34| image:: static/Manuale_utente_sitoweb_1_33.png
   :height: 273 px
   :width: 666 px

.. |IMG35| image:: static/Manuale_utente_sitoweb_1_34.png
   :height: 38 px
   :width: 37 px

.. |IMG36| image:: static/Manuale_utente_sitoweb_1_35.png
   :height: 329 px
   :width: 641 px

.. |IMG37| image:: static/Manuale_utente_sitoweb_1_36.png
   :height: 400 px
   :width: 486 px

.. |IMG38| image:: static/Manuale_utente_sitoweb_1_34.png
   :height: 38 px
   :width: 37 px

.. |IMG39| image:: static/Manuale_utente_sitoweb_1_37.png
   :height: 296 px
   :width: 618 px

.. |IMG40| image:: static/Manuale_utente_sitoweb_1_38.png
   :height: 349 px
   :width: 444 px

.. |IMG41| image:: static/Manuale_utente_sitoweb_1_39.png
   :height: 348 px
   :width: 641 px

.. |IMG42| image:: static/Manuale_utente_sitoweb_1_40.png
   :height: 345 px
   :width: 641 px

.. |IMG43| image:: static/Manuale_utente_sitoweb_1_41.png
   :height: 344 px
   :width: 641 px

.. |IMG44| image:: static/Manuale_utente_sitoweb_1_42.png
   :height: 101 px
   :width: 641 px

.. |IMG45| image:: static/Manuale_utente_sitoweb_1_43.png
   :height: 145 px
   :width: 288 px

.. |IMG46| image:: static/Manuale_utente_sitoweb_1_44.png
   :height: 88 px
   :width: 565 px

.. |IMG47| image:: static/Manuale_utente_sitoweb_1_45.png
   :height: 325 px
   :width: 384 px

.. |IMG48| image:: static/Manuale_utente_sitoweb_1_46.png
   :height: 72 px
   :width: 52 px

.. |IMG49| image:: static/Manuale_utente_sitoweb_1_47.png
   :height: 65 px
   :width: 62 px

.. |IMG50| image:: static/Manuale_utente_sitoweb_1_48.png
   :height: 68 px
   :width: 70 px

.. |IMG51| image:: static/Manuale_utente_sitoweb_1_49.png
   :height: 72 px
   :width: 61 px

.. |IMG52| image:: static/Manuale_utente_sitoweb_1_46.png
   :height: 32 px
   :width: 24 px

.. |IMG53| image:: static/Manuale_utente_sitoweb_1_50.png
   :height: 324 px
   :width: 641 px

.. |IMG54| image:: static/Manuale_utente_sitoweb_1_51.png
   :height: 32 px
   :width: 29 px

.. |IMG55| image:: static/Manuale_utente_sitoweb_1_52.png
   :height: 401 px
   :width: 481 px

.. |IMG56| image:: static/Manuale_utente_sitoweb_1_53.png
   :height: 22 px
   :width: 20 px

.. |IMG57| image:: static/Manuale_utente_sitoweb_1_51.png
   :height: 32 px
   :width: 29 px

.. |IMG58| image:: static/Manuale_utente_sitoweb_1_54.jpeg
   :height: 740 px
   :width: 516 px
